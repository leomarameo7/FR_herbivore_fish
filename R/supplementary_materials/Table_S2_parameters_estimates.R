...
fit0 = readRDS("outputs_results/models/fit_with_fish_density/fit_00.rds")
fitH1 = readRDS("outputs_results/models/fit_with_fish_density/fit_H1.rds")
fitH2 = readRDS("outputs_results/models/fit_with_fish_density/fit_H2.rds")
fitR1 = readRDS("outputs_results/models/fit_with_fish_density/fit_R1.rds")
fitR2 = readRDS("outputs_results/models/fit_with_fish_density/fit_R2.rds")
fitP1 = readRDS("outputs_results/models/fit_with_fish_density/fit_P1.rds")
fitP2 = readRDS("outputs_results/models/fit_with_fish_density/fit_P2.rds")
fit_Ivlev = readRDS("outputs_results/models/fit_with_fish_density/fit_IV.rds")
fit_Ivlev_ratio = readRDS("outputs_results/models/fit_with_fish_density/fit_IR.rds")# Ivlev ratio dependent model
...
estimate_null = as_data_frame(null[["fixed"]]) %>%
  ...
  add_column(Parameter = c("α: constant maximum intake rate", "Res. Stand. Dev."))%>% 
  add_column(Model = c("Null","Null"))
...
estimate_H1 = as_data_frame(H1[["fixed"]]) %>%
  ...
  rename(ESS = Bulk_ESS) %>% 
  rename(Post.Mean = Estimate) %>% 
  add_column(Parameter = c("a: attack rate", "Res. Stand. Dev."))%>% 
  add_column(Model = c("H1","H1"))
...
estimate_H2 = as_data_frame(H2[["fixed"]]) %>%
  ...
  rename(ESS = Bulk_ESS) %>% 
  rename(Post.Mean = Estimate) %>% 
  add_column(Parameter = c("a: attack rate", "h: handling time", "Res. Stand. Dev."))%>% 
  add_column(Model = c("H2","H2","H2"))
...
estimate_P2 = as_data_frame(c[["fixed"]]) %>%
  ...
  add_column(Model = c("P2","P2", "P2","P2"))
...
estimate_Ivlev = as_data_frame(Ivlev[["fixed"]]) %>%
  ...
  rename(ESS = Bulk_ESS) %>% 
  rename(Post.Mean = Estimate) %>% 
  add_column(Parameter = c("a: maximum feeding rate","d: satiation coeff.", "Res. Stand. Dev."))%>% 
  add_column(Model = c("IV","IV", "IV"))
...
estimate_IVR = as_data_frame(Ivlev_ratio[["fixed"]]) %>%
  ...
  rename(Post.Mean = Estimate) %>% 
  add_column(Parameter = c("a: maximum feeding rate","d: satiation coeff.", "Res. Stand. Dev."))%>% 
  add_column(Model = c("IVR","IVR", "IVR"))
